...
## 📌 Observações
- Cada exercício está separado por aula e numerado conforme o enunciado.  
- Os arquivos estão organizados em pastas (`aula1`, `aula2`, etc.) para facilitar a navegação.  
- O objetivo é praticar conceitos básicos e avançar gradualmente no aprendizado de Python.
